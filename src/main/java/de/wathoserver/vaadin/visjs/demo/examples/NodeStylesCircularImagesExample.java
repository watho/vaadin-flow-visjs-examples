...
@SpringComponent
@UIScope
public class NodeStylesCircularImagesExample extends AbstractExample {

  private final NetworkDiagram nd;
  private static final String IMAGEPATH = "frontend/img/indonesia/";

  public NodeStylesCircularImagesExample() {
    nd = new NetworkDiagram(Options.builder() //
        .withNodes(Nodes.builder().withBorderWidth(4).withSize(40) //
            .withColor(NodeColor.builder().withBorder("#222222").withBackground("#666666").build()) //
    ...
    final Node node1 =
        new Node("1", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "1.png"));
    final Node node2 =
        new Node("2", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "2.png"));
    final Node node3 =
        new Node("3", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "3.png"));
    final Node node4 = new Node("4", "pictures by this guy!",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "4.png"));
    final Node node5 =
        new Node("5", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "5.png"));
    final Node node6 =
        new Node("6", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "6.png"));
    final Node node7 =
        new Node("7", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "7.png"));
    final Node node8 =
        new Node("8", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "8.png"));
    final Node node9 =
        new Node("9", Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "9.png"));
    final Node node10 = new Node("10",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "10.png"));
    final Node node11 = new Node("11",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "11.png"));
    final Node node12 = new Node("12",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "12.png"));
    final Node node13 = new Node("13",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "13.png"));
    final Node node14 = new Node("14",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "14.png"));
    final Node node15 = new Node("15", "when images\nfail\nto load",
        Node.builder().withShape(Shape.circularImage).withImage(IMAGEPATH + "missing.png")
            .withBrokenImage(IMAGEPATH + "missingBrokenImage.png"));
    final Node node16 =
        new Node("16", "fallback image in action", Node.builder().withShape(Shape.circularImage)
