...
public class NodeStylesShadowsExample extends AbstractExample {

  private final NetworkDiagram nd;

  public NodeStylesShadowsExample() {
    this.getStyle().set("font", "12pt arial");
    this.getStyle().set("background-color", "#dddddd");
    this.getStyle().set("color", "#d3d3d3");
    ...
    nd = new NetworkDiagram(Options.builder() //
        .withNodes(Nodes.builder().withShape(Shape.dot).withSize(30)//
            .withFont(Font.builder().withSize(32).build())//
            .withBorderWidth(2) //
            .withShadow(true) //
            .build()) //
        .withEdges(Edges.builder().withWidth(2.0).withShadow(true).build()) //
        .build());
    ...
    // Set Edges
    nd.setEdges(new Edge("1", "0"), new Edge("2", "0"), new Edge("4", "3"), new Edge("5", "4"),
        new Edge("4", "0"), new Edge("7", "6"), new Edge("8", "7"), new Edge("7", "0"),
        new Edge("10", "9"), new Edge("11", "10"), new Edge("10", "4"), new Edge("13", "12"),
        new Edge("14", "13"), new Edge("13", "0"), new Edge("16", "15"), new Edge("17", "15"),
        new Edge("15", "10"), new Edge("19", "18"), new Edge("20", "19"), new Edge("19", "4"),
        new Edge("22", "21"), new Edge("23", "22"), new Edge("22", "13"), new Edge("25", "24"),
        new Edge("26", "25"), new Edge("25", "7"),
        new Edge("28", "27",
            Edge.builder()
                .withShadow(Shadow.builder().withEnabled(true).withColor("rgb(0,255,0)").build())),
        new Edge("29", "28"),
        new Edge("28", "0"));
    add(nd);
  }
